            ...
            <form method="POST" action="{{ route('users.update', $user) }}">
                ...
                <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
                    ...
                    <div class="px-5 py-4 border-t border-gray-200">
                        <label class="block text-sm font-medium text-gray-700 mb-3">Status do usuário</label>
                        ...
                        <div class="grid grid-cols-2 gap-2">
                            <label class="cursor-pointer">
                                ...
                                <div class="py-2.5 px-4 text-center text-sm font-medium rounded-lg border-2 border-gray-200 transition-all
                                            peer-checked:border-green-500 peer-checked:bg-green-500 peer-checked:text-white
                                            text-gray-600 hover:border-gray-300 flex items-center justify-center gap-2">
                    ...
                    <div class="p-5 border-t border-gray-200">
                        <div class="flex items-center justify-between mb-3">
                            ...
                            <span class="text-xs text-gray-400 uppercase tracking-wide">Opcional</span>
                        </div>
                        <div class="grid grid-cols-2 gap-4">
                            <div>
