...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" x-data x-bind:class="$store.darkMode?.on ? 'dark' : ''">
    <head>
        ...
        <title>Acesso negado - {{ config('app.name', 'FoodDesk') }}</title>
    ...
    <body class="font-sans antialiased">
        <div class="min-h-screen flex flex-col justify-center items-center px-4 bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-900 dark:to-gray-800 transition-colors duration-300">
            <!-- Ilustração -->
            <div class="mb-8">
                <div class="w-32 h-32 bg-gradient-to-br from-red-500 to-red-600 rounded-full flex items-center justify-center shadow-xl">
            ...
            <div class="text-center">
                <h1 class="text-8xl font-bold text-gray-300 dark:text-gray-700">403</h1>
                <h2 class="mt-4 text-2xl font-semibold text-gray-800 dark:text-gray-100">Acesso negado</h2>
